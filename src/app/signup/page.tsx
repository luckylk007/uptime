    ...
    <div className="min-h-screen bg-[#070e1e] flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center relative z-10 space-y-3">
        ...
        <p className="text-xs sm:text-sm text-slate-400">
          Get started with up to 5 automated 5-minute uptime monitors.
        </p>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        <div className="bg-white py-8 px-6 sm:px-10 shadow-2xl rounded-3xl border border-slate-200">
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            {successMsg && (
              <div className="p-3 rounded-xl bg-emerald-50 border border-emerald-200 text-emerald-700 text-xs font-medium flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-[#70BB3C]" />
          ...
          <div className="mt-6 text-center text-xs text-slate-500">
            ...
            <Link href="/login" className="font-bold text-[#70BB3C] hover:underline">
              Sign In
            </Link>
          </div>
        </div>
